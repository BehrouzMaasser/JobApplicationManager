...
urlpatterns = [
    ...
    path("", DocumentListView.as_view(), name="document-list-web"),
    path("create/", DocumentCreateView.as_view(), name="document-create-web"),
    path("<int:pk>/", DocumentDetailView.as_view(), name="document-detail-web"),
    path("<int:pk>/edit/", DocumentUpdateView.as_view(), name="document-edit-web"),
    path("<int:pk>/delete/", DocumentDeleteView.as_view(), name="document-delete-web"),
    path("<int:pk>/download/", DownloadDocumentView.as_view(), name="document-download-web"),
    path("<int:pk>/open/", OpenDocumentView.as_view(), name="document-open-web"),
]
