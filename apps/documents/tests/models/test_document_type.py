...
@pytest.mark.django_db
def test_lower_name_is_unique_per_user(user):
...
@pytest.mark.django_db
def test_same_name_different_user_is_allowed(user, other_user):
...
@pytest.mark.django_db
def test_empty_or_missing_description_assigns_none_after_save(user):
