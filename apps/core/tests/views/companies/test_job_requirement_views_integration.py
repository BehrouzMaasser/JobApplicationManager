# Job Requirement integration tests audit:
...
#   requirements can be created for the same user).
...
class TestJobRequirementCreateView:
    ...
    def test_duplicate_submission_shows_form_errors(
        ...
        response = client.post(
            reverse("job-requirement-create-web"),
            {
                "title": job_requirement1_user1.title,
                "description": job_requirement1_user1.description,
            },
        )
