...
class TestCompanySerializer:
    ...
    def test_valid_data(self, co1_ws1_user1_api_v1_valid_data):

        serializer = CompanySerializer(data=co1_ws1_user1_api_v1_valid_data)

        assert serializer.is_valid(), serializer.errors

    def test_name_required(self, co1_ws1_user1_api_v1_valid_data):

        payload = co1_ws1_user1_api_v1_valid_data.copy()
        payload.pop("name")
    ...
    def test_name_cannot_be_blank(self, co1_ws1_user1_api_v1_valid_data):
    ...
    def test_website_must_be_valid_url(self, co1_ws1_user1_api_v1_valid_data):
    ...
    def test_website_can_be_null(self, co1_ws1_user1_api_v1_valid_data):
    ...
    def test_website_is_optional(self, co1_ws1_user1_api_v1_valid_data):
